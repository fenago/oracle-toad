...
<report name="subtotal" DTDVersion="9.0.2.0.10">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <dataSource name="Q_STAFF">
      <select>
      <![CDATA[SELECT NAME, SALARY, SALARY * 1.15 SAL_INCREASE, COMM
FROM STAFF
WHERE DEPT = 10

]]>
      </select>
      <displayInfo x="0.67712" y="0.75000" width="0.69995" height="0.75000"/>
      <group name="G_STAFF">
        <displayInfo x="0.36853" y="2.32300" width="1.42126" height="0.94336"
        />
        <dataItem name="NAME" datatype="vchar2" columnOrder="11" width="11"
        ...
        <dataItem name="SALARY" oracleDatatype="number" columnOrder="12"
         ...
         columnFlags="33" defaultLabel="Salary">
          <dataDescriptor expression="SALARY" descriptiveExpression="SALARY"
           order="2" oracleDatatype="number" width="22" scale="2"
           precision="7"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SAL_INCREASE" oracleDatatype="number" columnOrder="13"
         width="22" defaultWidth="90000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Sal Increase">
          <xmlSettings xmlTag="SALARY_1_15"/>
          <dataDescriptor expression="SALARY * 1.15"
           descriptiveExpression="SAL_INCREASE" order="3"
           oracleDatatype="number" width="22" precision="38"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="COMM" oracleDatatype="number" columnOrder="14"
         width="22" defaultWidth="90000" defaultHeight="10000"
         columnFlags="33" defaultLabel="Comm">
          <dataDescriptor expression="COMM" descriptiveExpression="COMM"
           order="4" oracleDatatype="number" width="22" scale="2"
           precision="7"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
      </group>
    </dataSource>
    <summary name="SumSAL_INCREASEPerReport" source="SAL_INCREASE"
     function="sum" width="22" precision="38" reset="report" compute="report"
     defaultWidth="90000" defaultHeight="10000" columnFlags="552"
     defaultLabel="Total: New Salary">
  ...
  <section name="main">
    <body>
      <frame name="M_G_STAFF_GRPFR">
        <geometryInfo x="0.00000" y="0.00000" width="6.62500" height="2.75000"
        />
        <generalLayout verticalElasticity="variable"/>
        <visualSettings fillPattern="transparent"
         fillBackgroundColor="r100g100b100"/>
        <repeatingFrame name="R_G_STAFF" source="G_STAFF"
         printDirection="down" minWidowRecords="1" columnMode="no">
          <geometryInfo x="0.00000" y="0.75000" width="5.68750"
           height="0.25000"/>
          ...
          <field name="F_NAME" source="NAME" minWidowLines="1" spacing="0"
           alignment="start">
            ...
            <geometryInfo x="0.00000" y="0.75000" width="1.50000"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_SALARY" source="SALARY" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="1.50000" y="0.75000" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_SAL_INCREASE" source="SAL_INCREASE" minWidowLines="1"
           spacing="0" alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="2.87500" y="0.75000" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_COMM" source="COMM" minWidowLines="1" spacing="0"
           alignment="start">
            <font face="helvetica" size="10"/>
            <geometryInfo x="4.25000" y="0.75000" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
        </repeatingFrame>
        <frame name="M_G_STAFF_FTR">
          <geometryInfo x="0.00000" y="1.31250" width="5.75000"
           height="0.50000"/>
          <advancedLayout printObjectOnPage="lastPage"
           basePrintingOn="anchoringObject"/>
          <visualSettings fillPattern="transparent"
           fillBackgroundColor="Totals"/>
          <field name="F_SumSAL_INCREASEPerReport"
           source="SumSAL_INCREASEPerReport" minWidowLines="1"
           formatMask="LNNNGNN0D00" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="2.87500" y="1.31250" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_SumCOMMPerReport" source="SumCOMMPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="4.25000" y="1.31250" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <field name="F_MaxSALARYPerReport" source="MaxSALARYPerReport"
           minWidowLines="1" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"/>
            <geometryInfo x="1.50000" y="1.50000" width="1.37500"
             height="0.18750"/>
            <generalLayout verticalElasticity="expand"/>
          </field>
          <text name="B_Total_" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.00000" y="1.31250" width="0.43750"
             height="0.18750"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"/>
              <string>
          ...
          <text name="B_Maximum_" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="0.00000" y="1.50000" width="0.93750"
             height="0.18750"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"/>
              <string>
        ...
        <frame name="M_G_STAFF_HDR">
          <geometryInfo x="0.00000" y="0.06250" width="5.68750"
           height="0.56250"/>
          ...
          <text name="B_SALARY" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="1.50000" y="0.37500" width="1.37500"
             height="0.18750"/>
          ...
          <text name="B_SAL_INCREASE" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="2.87500" y="0.37500" width="1.37500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <text name="B_COMM" minWidowLines="1">
            <textSettings spacing="0"/>
            <geometryInfo x="4.25000" y="0.37500" width="1.37500"
             height="0.18750"/>
            <visualSettings fillBackgroundColor="TableHeading"/>
            <textSegment>
              <font face="helvetica" size="10" bold="yes"
          ...
          <field name="F_1" source="CurrentDate" minWidowLines="1"
           formatMask="DD MON RRRR" spacing="0" alignment="start">
            <font face="helvetica" size="10" bold="yes"
             textColor="r100g100b100"/>
            <geometryInfo x="2.37500" y="0.12500" width="1.00000"
             height="0.18750"/>
            <visualSettings fillPattern="transparent"
             fillBackgroundColor="TableHeading"/>
          </field>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
      ...
      <text name="B_OR$BODY_SECTION" minWidowLines="1">
        <textSettings spacing="0"/>
        <geometryInfo x="3.24951" y="0.25000" width="2.00098" height="0.16675"
        />
        <textSegment>
          <font face="Courier New" size="10"/>
          <string>
          <![CDATA[EMPLOYEE SALARY INCREASE]]>
          </string>
        </textSegment>
      </text>
    </margin>
  ...
  <reportPrivate defaultReportType="tabular" versionFlags2="0"
   templateName="rwgreen" sectionTitle="EMPLOYEE SALARY INCREASE"/>
  <reportWebSettings>
  <![CDATA[#NULL#]]>
  </reportWebSettings>
</report>
...
<rw:dataArea id="MGSTAFFGRPFR40">
<table class="OraTable">
<caption> EMPLOYEE SALARY INCREASE </caption>
 <!-- Header -->
 <thead>
  <tr>
   <th <rw:id id="HBNAME40" asArray="no"/> class="OraColumnHeader"> Name </th>
   <th <rw:id id="HBSALARY40" asArray="no"/> class="OraColumnHeader"> Salary </th>
   <th <rw:id id="HBSALINCREASE40" asArray="no"/> class="OraColumnHeader"> Sal Increase </th>
   <th <rw:id id="HBCOMM40" asArray="no"/> class="OraColumnHeader"> Comm </th>
  </tr>
 </thead>
 <!-- Body -->
 <tbody>
  <rw:foreach id="RGSTAFF401" src="G_STAFF">
   <tr>
    <td <rw:headers id="HFNAME40" src="HBNAME40"/> class="OraCellText"><rw:field id="FNAME40" src="NAME" nullValue="&nbsp;"> F_NAME </rw:field></td>
    <td <rw:headers id="HFSALARY40" src="HBSALARY40"/> class="OraCellNumber"><rw:field id="FSALARY40" src="SALARY" nullValue="&nbsp;"> F_SALARY </rw:field></td>
    <td <rw:headers id="HFSALINCREASE40" src="HBSALINCREASE40"/> class="OraCellNumber"><rw:field id="FSALINCREASE40" src="SAL_INCREASE" nullValue="&nbsp;"> F_SAL_INCREASE </rw:field></td>
    <td <rw:headers id="HFCOMM40" src="HBCOMM40"/> class="OraCellNumber"><rw:field id="FCOMM40" src="COMM" nullValue="&nbsp;"> F_COMM </rw:field></td>
   </tr>
  </rw:foreach>
 </tbody>
 ...
 <tr>
  ...
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFSumSALINCREASEPerReport40" src="HBSALINCREASE40"/> class="OraTotalNumber">Total: New Salary <rw:field id="FSumSALINCREASEPerReport40" src="SumSAL_INCREASEPerReport" nullValue="&nbsp;"> F_SumSAL_INCREASEPerReport </rw:field></td>
  <td <rw:headers id="HFSumCOMMPerReport40" src="HBCOMM40"/> class="OraTotalNumber">Total: of Commissions <rw:field id="FSumCOMMPerReport40" src="SumCOMMPerReport" nullValue="&nbsp;"> F_SumCOMMPerReport </rw:field></td>
 </tr>
 <tr>
  <th class="OraTotalText"> &nbsp; </th>
  <td <rw:headers id="HFMaxSALARYPerReport40" src="HBSALARY40"/> class="OraTotalNumber">Maximum Sal <rw:field id="FMaxSALARYPerReport40" src="MaxSALARYPerReport" nullValue="&nbsp;"> F_MaxSALARYPerReport </rw:field></td>
  <th class="OraTotalText"> &nbsp; </th>
  <th class="OraTotalText"> &nbsp; </th>
 </tr>
</table>
